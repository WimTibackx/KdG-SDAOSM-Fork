angular.module("cpa.ctrl").controller('RegisterCtrl', ['$scope', '$state', 'cpa.svc.api.v1', function ($scope, $state, cpa_api) {
	$scope.ud = { 
		model: {},
	...
	$scope.ud.submit = function() {
		...
		dateOfBirth = $scope.ud.model.dateOfBirth,//($scope.ud.model.dateOfBirth == undefined ? "" : $scope.ud.model.dateOfBirth.toISOString().split("T")[0]),
